...
def elapsed_time(startTime):
    delta_seconds = int(time.time()) - int(startTime)
    elapsed_minutes = delta_seconds // 60
    elapsed_seconds = delta_seconds % 60
...
class SampleListener(Leap.Listener):
	...
	def on_frame(self, controller):
		# print(controller.get_policy())
		# print(Leap.Controller.POLICY_OPTIMIZE_HMD)
		controller.set_policy(Leap.Controller.POLICY_OPTIMIZE_HMD)
		#print(controller.isPolicySet(Leap.Controller.PolicyFlag.POLICY_OPTIMIZE_HMD))
		time.sleep(0.25)
		...
		if not (frame.hands.is_empty and frame.gestures().is_empty):
			...
			#First gesture - pos:x,y,z; normal:x,y,z;
			recorded_variables_gesture_1 = [left_palm_position_x,left_palm_position_y,left_palm_position_z,right_palm_position_x,right_palm_position_y,right_palm_position_z,left_palm_normal_x,left_palm_normal_y,left_palm_normal_z,right_palm_normal_x,right_palm_normal_y,right_palm_normal_z]
			
			#Second gesture - pos:x,y,z; normal:x,y,z;
			# recorded_variables_gesture_2 = [left_palm_position_x,left_palm_position_y,left_palm_position_z,right_palm_position_x,right_palm_position_y,right_palm_position_z,left_palm_normal_x,left_palm_normal_y,left_palm_normal_z,right_palm_normal_x,right_palm_normal_y,right_palm_normal_z]

			#Third gesture - pos:x,y,z; normal:x,y,z;
			# recorded_variables_gesture_2 = [left_palm_position_x,left_palm_position_y,left_palm_position_z,right_palm_position_x,right_palm_position_y,right_palm_position_z,left_palm_normal_x,left_palm_normal_y,left_palm_normal_z,right_palm_normal_x,right_palm_normal_y,right_palm_normal_z]
			


			line = ""
			for attribute in recorded_variables_gesture_1:
				line = line + str(attribute) + ","

			elapsed_minutes, elapsed_seconds = elapsed_time(startTime)
			timestamp = "{:02d}:{:02d}".format(int(elapsed_minutes), int(elapsed_seconds))
			...
			print( "Recordeddd:" + str(time.time()))
			#print( line
